...
int aw99703_set_brightness(int brt_val)
{
	...
	//brt_val = aw99703_brightness_map(brt_val);//lixuehua del temp
	...
	g_aw99703_data->brightness = brt_val;
		...
		const struct i2c_device_id *id)
{
	...
	aw99703_set_brightness(614);//2047*30%
